...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { InstructorCourse: @recommendation.InstructorCourse, InstructorDepartment: @recommendation.InstructorDepartment, InstructorEmail: @recommendation.InstructorEmail, InstructorName: @recommendation.InstructorName, Recommendation: @recommendation.Recommendation, StudentName: @recommendation.StudentName, grader_application_id: @recommendation.grader_application_id } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { InstructorCourse: @recommendation.InstructorCourse, InstructorDepartment: @recommendation.InstructorDepartment, InstructorEmail: @recommendation.InstructorEmail, InstructorName: @recommendation.InstructorName, Recommendation: @recommendation.Recommendation, StudentName: @recommendation.StudentName, grader_application_id: @recommendation.grader_application_id } }
